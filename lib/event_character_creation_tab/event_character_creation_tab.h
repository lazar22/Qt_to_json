...
#ifndef EVENT_CHARACTER_CREATION_TAB_H
#define EVENT_CHARACTER_CREATION_TAB_H
...
class event_character_creation_tab final : public QWidget
{
    Q_OBJECT
...
public:
    explicit event_character_creation_tab(QWidget* parent = nullptr, const QString _file_path_ = "");

    ~event_character_creation_tab() override = default;
...
signals:
    void event_character_created();
};

#endif //EVENT_CHARACTER_CREATION_TAB_H
