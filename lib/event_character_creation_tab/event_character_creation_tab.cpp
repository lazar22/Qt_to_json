...
event_character_creation_tab::event_character_creation_tab(QWidget* parent, const QString _file_path_)
...
void event_character_creation_tab::setup_ui()
{
    ...
    basic_info->addRow("Select Character:", &_character_selector);
...
void event_character_creation_tab::connect_signals()
{
...
void event_character_creation_tab::create_stats_input_fields()
{
    QLineEdit* inputs[] = {
        &_hp_input, &_atk_input, &_def_input, &_healing_input,
        &_accuracy_input, &_evasion_input, &_crit_input,
...
void event_character_creation_tab::refresh_character_list()
{
